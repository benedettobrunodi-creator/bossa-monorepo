...
export const metadata: Metadata = {
  title: "Sobre",
  description: "Boutique imobiliária especializada no litoral de São Paulo. Riviera de São Lourenço, São Sebastião, Guarujá e região.",
};
        ...
        <section className="bg-white py-24">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <div>
                <h2 className="font-serif text-3xl mb-6">Litoral de São Paulo</h2>
                <p className="text-brand-gray leading-relaxed mb-6">
                  Operamos nas praias mais desejadas do estado: Riviera de São Lourenço, Baleia, Sahy e Juquehy em São Sebastião, Maresias, Camburi e os condomínios de Iporanga e Tijucopava no Guarujá. Casas pé na areia, condomínios fechados e coberturas com vista para o mar.
                </p>
                <ul className="flex flex-wrap gap-2">
                  {["Riviera de São Lourenço", "Baleia", "Juquehy", "Maresias", "Camburi", "Iporanga", "Tijucopava"].map((c) => (
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              {
                titulo: "Praia & Litoral",
                desc: "Casas de praia, condomínios pé na areia e refúgios de frente para o mar. Conhecemos profundamente as regiões onde atuamos.",
              },
              {
                titulo: "Off-Catalog",
