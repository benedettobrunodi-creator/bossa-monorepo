...
export const metadata: Metadata = {
  title: "Contato",
  description: "Fale com um consultor da Bossa Praia.",
};
          ...
          <div>
            ...
            <div className="flex flex-col gap-6 text-sm">
              <div>
                ...
                <a href="mailto:contato@bossapraia.com.br" className="text-brand-graphite hover:text-brand-green transition-colors">
              ...
              <div>
                ...
                <a href="https://instagram.com/bossapraia" target="_blank" rel="noopener noreferrer" className="text-brand-graphite hover:text-brand-green transition-colors">
                  @bossacampo
                </a>
              </div>
            </div>
