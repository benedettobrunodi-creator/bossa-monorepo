...
export const metadata = { title: "Avalie seu imóvel — Bossa & Co." };
      ...
      <main className="pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6 text-center mb-14">
          ...
          <p className="text-sm text-brand-gray max-w-2xl mx-auto leading-relaxed">
            Nosso observatório de mercado monitora diariamente mais de 19.000 imóveis à venda nos bairros
            mais nobres de São Paulo. Descubra em segundos a faixa de valor do seu — com base em dados reais,
            não em achismo.
          </p>
        </div>
        <div className="max-w-4xl mx-auto px-6">
          <AvalieForm workspace="BOSSA_CO" whatsappMarca="5511921226156" />
        </div>
      </main>
      <Footer />
      <WhatsAppButton />
