        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            {(imovel.arquiteto || imovel.reformado) && (
              <div className="flex flex-wrap gap-2 mb-6 -mt-2">
                {imovel.arquiteto && <span className="bg-brand-graphite text-white text-[10px] tracking-widest uppercase px-3 py-1.5">Assinado · {imovel.arquiteto}</span>}
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 border border-brand-gray-light p-8">
              ...
              <a
                href={`https://wa.me/5511921226156?text=${encodeURIComponent(`Olá! Tenho interesse no imóvel "${imovel.titulo}" — https://bossaeco.com.br/imoveis/${imovel.slug}`)}`}
