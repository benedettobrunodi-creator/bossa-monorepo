export const metadata = { title: "Política de Privacidade — Bossa & Co." };
...
export default function PoliticaPrivacidade() {
  return (
    <main style={{ maxWidth: 720, margin: "0 auto", padding: "96px 24px 64px", lineHeight: 1.7 }}>
      ...
      <p>A Bossa & Co. respeita a sua privacidade e trata dados pessoais em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018 — LGPD).</p>
